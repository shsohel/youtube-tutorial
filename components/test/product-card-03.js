...
const ProductCard03 = () => {
  const [isShowQuickViewLabel, setIsShowQuickViewLabel] = useState(false);

  const handleQuickViewLabel = (condition) => {
    setIsShowQuickViewLabel(condition);
  };

  return (
    <div className="flex justify-center items-center min-h-screen bg-[#FF9529] text-[#263E4A]">
      <div className="min-h-[520px] w-[300px] bg-[#F4F5F8]  relative">
        <div
        ...
        >
          ...
          <div
            hidden={!isShowQuickViewLabel}
            className="absolute right-4 top-10 "
          >
            <p className="text-xs bg-white p-2 rounded-2xl  shadow">
              Quick View
            </p>
          </div>
          ...
          <div className="absolute top-[14.6rem]  w-full -mt-2 p-3">
            <div className="bg-white  border rounded-xl h-[270px] shadow-xl">
              ...
              <div className="flex justify-center gap-3 my-1 uppercase font-medium">
                ...
                <div className="w-9 h-9 border-2 border-[#263E4A] rounded-full p-1 bg-[#263E4A] text-center text-white hover:bg-white hover:text-[#263E4A]">
                  m
                </div>
                <div className="w-9 h-9 border-2 border-[#263E4A] rounded-full p-1  text-center hover:bg-[#263E4A] hover:text-white">
                  L
